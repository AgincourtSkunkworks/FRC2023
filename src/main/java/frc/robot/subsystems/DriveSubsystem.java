...
public class DriveSubsystem extends SubsystemBase {
     ...
     */
    public DriveSubsystem(int l1ID, int l2ID, int r1ID, int r2ID, boolean lInvert, boolean rInvert, double lCorrect, double rCorrect) {
     ...
     */
    public double getLeftPos() {return leftMotor1.getSelectedSensorPosition();}
     ...
     */
    public double getRightPos() {return rightMotor1.getSelectedSensorPosition();}
    public double getLeft1Pos() {return leftMotor1.getSelectedSensorPosition();}
    public double getLeft2Pos() {return leftMotor2.getSelectedSensorPosition();}
    public double getRight1Pos() {return rightMotor1.getSelectedSensorPosition();}
    public double getRight2Pos() {return rightMotor2.getSelectedSensorPosition();}
